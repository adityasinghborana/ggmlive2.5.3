  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(helper.getTranslated(context, AppTags.enterYourphone)!,
          ...
          Form(
            ...
            child: EditTextUtils().getCustomEditTextField(
                hintValue: helper.getTranslated(context, AppTags.phonAuthHintValue),
          ...
          Padding(
            ...
            child: GestureDetector(
                ...
                child: HelpMe().submitButton(screnWidth,helper.getTranslated(context, AppTags.continueText)!,)),
          ),
          Text(helper.getTranslated(context, AppTags.byTappingContinue)!,style: CustomTheme.subTitleTextColored,
          )
        ],
      ),
    );
