...
class _JoinMeetingState extends State<JoinMeeting> {
  ...
  void initState() {
    ...
    interstitialAd = AdmobInterstitial(
      ...
      //Hive.box<GetConfigModel>('getConfigbox').getAt(0).adsConfig.admobInterstitialAdsId,
                ...
                child:  Column(
                  ...
                  helper.getTranslated(context, AppTags.joinAMeeting)!,
                    ...
                    EditTextUtils().getCustomEditTextField(
                        hintValue: helper.getTranslated(context, AppTags.meetingID),
                        ...
                        suffixWidget: GestureDetector(
                            onTap: () async {
                              ClipboardData data = await (Clipboard.getData('text/plain') as FutureOr<ClipboardData>);
                    ...
                    SizedBox(height: 22,),
                    EditTextUtils().getCustomEditTextField(
                      hintValue: helper.getTranslated(context, AppTags.yourNickName),
                    ...
                    GestureDetector(onTap: () async {
                     ...
                     child: HelpMe().submitButton(screnWidth, helper.getTranslated(context, AppTags.joinNow)!,)),
                  ],
                ),
              )
            ),
