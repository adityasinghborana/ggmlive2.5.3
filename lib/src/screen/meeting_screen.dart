      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text( helper.getTranslated(context, AppTags.titleMeetingScreen)!,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              tabButton(0, helper.getTranslated(context, AppTags.joinMeeting)!,),
              tabButton(1, helper.getTranslated(context, AppTags.hostMeeting)!,),
            ],
          ),
          SizedBox(height: 10.0),
          Container(
