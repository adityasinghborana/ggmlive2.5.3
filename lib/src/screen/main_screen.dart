...
class _MainScreenState extends State<MainScreen> with SingleTickerProviderStateMixin{
  ...
  AuthUser? authUser;
  late GetConfigService configService;
              ...
              child: ConvexAppBar(
                ...
                items: [
                  bottomNavigationTabIcon(
                      ...
                      title:  helper.getTranslated(context, AppTags.tabsHistory),),
                  TabItem(
                    isIconBlend: false,
                    activeIcon: Image.asset('assets/images/tabs/meeting_active.png'),
                    icon: Image.asset('assets/images/tabs/meeting_inactive.png'),
                    title:  helper.getTranslated(context, AppTags.tabsMeetingEmptyText), //no title
                  ),
                  bottomNavigationTabIcon(
                      icon: 'assets/images/tabs/setting_inactive.png',
                      activeIcon: 'assets/images/tabs/setting_active.png',
                      title: helper.getTranslated(context, AppTags.tabsSettings),),
                ],
